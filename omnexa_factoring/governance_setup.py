...
POLICY_DTYPE = "Factoring Policy Version"
SNAP_DTYPE = "Factoring Audit Snapshot"
CHART_POL = "Factoring Governance - Policies by Status"
CHART_SNP = "Factoring Governance - Snapshots (Last Month)"
...
def _ensure_workspace():
	...
	ws.content = json.dumps([
		{"id": "omnexa_factoring-h", "type": "header", "data": {"text": "<span class=\"h4\"><b>Factoring Governance</b></span>", "col": 12}},
		{"id": "omnexa_factoring-c1", "type": "card", "data": {"card_name": "Governance", "col": 4}},
		{"id": "omnexa_factoring-ch1", "type": "chart", "data": {"chart_name": CHART_POL, "col": 4}},
		{"id": "omnexa_factoring-ch2", "type": "chart", "data": {"chart_name": CHART_SNP, "col": 4}},
	])
