...
from omnexa_factoring.governance import (
...
class TestFactoringGovernance(FrappeTestCase):
	def test_submit_policy_and_snapshot(self):
		...
		pols = list_policy_versions("omnexa_factoring", policy_name="pricing_policy")
		...
		snaps = list_audit_snapshots("omnexa_factoring", process_name="decision_preview", limit=10)
		self.assertTrue(snaps)

		ov = governance_overview("omnexa_factoring")
